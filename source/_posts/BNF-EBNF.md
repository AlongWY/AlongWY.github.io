---
title: BNF和EBNF的含义及其用法
tags:
  - BNF
  - EBNF
date: 2017-08-21 20:18:01
categories: 学习
---
# 序
...
[BNF 和EBNF的含义与用法 原文](http://www.garshol.priv.no/download/text/bnf.html)By: Lars Marius Garshol 

[BNF 和EBNF的含义与用法 译文](http://www.javashuo.com/content/p-2634023.html)

（本文是上述作者文章的翻译，原文版权归作者所有      译者：Sunnybill）

以下是该博文的转载。

# 简介
## 关于本文
这是一篇针对< 16.Jun.98年6月16日发布在comp.text.sgml >的信息而写的一篇解释BNF的短文，有些粗略，不详之处可与作者联系，作者将会尽量解释。
...
在[BNF web club](http://cuiwww.unige.ch/db-research/Enseignement/analyseinfo/BNFweb.html)上可以查到BNF的一个语法集。
...
Frank Boumphrey的[another EBNF tutorial](http://www.hypermedic.com/style/xml/ebnf.htm)
...
定义BNF语法的句法规则在[RFC 2234](http://www.ietf.org/rfc/rfc2234.txt)中可以找到，the ISO 14977 standard中也有。


# 附录
致谢
* [Jelks Cabaniss](http://cpcug.org/user/jelks), for encouraging me to turn the news article into a web article, and for providing very useful criticism of the article once it appeared in web form.
* C. M. Sperberg-McQueen for extra historical information about the name of BNF.
* [Scott Stanchfield](http://www.jguru.com/thetick/) for writing the great comparison of LALR and LL. I have asked for permission to quote this, but have received no reply, unfortunately.
* James Huddleston for correcting me on John Backus' name.
* [Dave Pawson](http://www.dpawson.co.uk/) for correcting a bad link.
