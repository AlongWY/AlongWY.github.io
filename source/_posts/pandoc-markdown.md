---
title: Pandoc's 的 Markdown 语法拓展
tags:
  - pandoc
  - markdown
date: 2017-12-12 16:38:19
categories: 学习
---
...
这份文件是 [Pandoc][pandoc] 版本 Markdown 语法的中文翻译。Pandoc 本身是由 [John MacFarlane][John MacFarlane] 所开发的文件转换工具，可以在 HTML, Markdown, PDF, TeX...等等格式之间进行转换。
...
Writed by John MacFarlane; Translated by [Tzeng Yuxio][Tzeng Yuxio]
...
[Tzeng Yuxio]: http://pages.tzengyuxio.me/pandoc/
